...
| [`sweepit/no-handle-prefix-utils`](https://github.com/jjenzz/sweepit/tree/main/skills/sweepi/rules/no-handle-prefix-utils.md)                         | Reserves `handle*` naming for functions used in JSX `on*` props, not general utility/helper functions.                                                                     |
